...
namespace Prova.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(ProvaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Cpf,Email")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Cpf,Email")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
